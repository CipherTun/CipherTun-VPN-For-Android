...
import io.surprise.ciphertun.ktx.unwrap
...
class GitHubUpdateChecker : Closeable {
    companion object {
        // Was "SagerNet/sing-box" -- that's upstream's OWN repo, whose
        // releases carry SFA-*.apk assets for the original app. Left as-is,
        // this checker would find those, decide they're a newer version,
        // and offer to install the original sing-box-for-android over
        // CipherTun. Points at CipherTun's own repo now; this stays
        // harmless (finds nothing) until CI publishes matching GitHub
        // Releases with an SFA-version-metadata.json asset per release.
        private const val RELEASES_URL = "https://api.github.com/repos/CipherTun/CipherTun-VPN-For-Android/releases"
